...
<div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('supplier.update', $id->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('qty') is-invalid @enderror" id="qty" name="qty" value="{{ $id->qty }}">
                        @error('qty')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
